...
import { calculateRgba, heightWidthDefaults, cssValue } from "../utils";
...
class Loader extends React.PureComponent<Required<LoaderHeightWidthProps> & { className?: string }> {
  ...
  public render(): JSX.Element | null {
    ...
    return loading ? (
      //@ts-ignore
      <span css={[this.wrapper(), css]} className={this.props.className}>
          {/* @ts-ignore */}
